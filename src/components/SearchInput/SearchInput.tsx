      ...
      <div className={cn(
        ...
        <div className="relative">
          ...
          <input
            ...
            onChange={onChange}
            className={cn(
              'w-full pl-10 pr-4 py-2 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400',
